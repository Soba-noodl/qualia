...
Built entirely with AI agents (Claude Code). The `.claude/skills/` folder contains the project-specific Claude skills used during development. The full design + implementation record (per-feature specs and plans) lives in the source private repo and is not shipped publicly.

export const faq = {
  en: {
    ...
    faqA18:
      "Yes. Qualia is a free portfolio project. You bring your own AI provider key (Gemini or GPT) and pay the provider directly per audit; we don't charge for the platform. Per-provider frame caps apply for performance reasons: up to 50 frames on Gemini, 35 on GPT.",
  ...
  it: {
    ...
    faqA18:
      "Sì. Qualia è un progetto di portfolio gratuito. Porti la tua chiave AI (Gemini o GPT) e paghi direttamente il provider per ogni audit; noi non addebitiamo nulla per la piattaforma. Per ragioni di performance, ci sono limiti per provider sul numero di frame analizzabili: fino a 50 con Gemini, 35 con GPT.",

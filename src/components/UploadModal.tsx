...
interface UploadModalProps {
  ...
  onFlowUpload?: (files: File[], selectedPersonas: UploadPersona[], screenContext: string, userData?: string, synthPersonaIds?: string[], reauditUserNote?: string, provider?: import("@/services/llm-key.service").LLMProvider) => void;
...
const UploadModal = ({
  ...
  const handleFlowUpload = (files: File[], selectedPersonas: UploadPersona[], screenContext: string, userData?: string, synthPersonaIds?: string[], reauditUserNote?: string) => {
    if (onFlowUpload) {
      onFlowUpload(files, selectedPersonas, screenContext, userData, synthPersonaIds, reauditUserNote);
    }
  };

        ...
        <div className="max-w-3xl mx-auto prose prose-invert">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              <li>{t("privacyControllerLocation")}</li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              <li>
                <strong className="text-foreground">{t("privacyAiProvidersAnthropic")}</strong>{" "}
                <a href={t("privacyAiProvidersAnthropicUrl")} target="_blank" rel="noopener noreferrer">
                  {t("privacyAiProvidersAnthropicUrl")}
                </a>
              </li>
              <li>

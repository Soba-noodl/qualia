...
- [ ] No new hardcoded operator-specific values (URLs, project IDs, personal emails) — see `agent_docs/danger-zones.md` → "vercel.json — Strict Schema, No Comments" + `lessons/supabase.md` → "Cron secrets live in TWO stores"

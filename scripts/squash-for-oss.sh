...
COMMIT_MSG="chore: initial public release (Open v10.0)
...
This commit is the squashed initial state — full development history is
retained in the private repo Soba-noodl/qualia-mvp. Operator-personal
material (research notes, contacts, building logs, internal planning
docs, IDE configs, scratchpads) is intentionally excluded per
.squash-exclude in the source repo.
...
git tag -a v10.0 -m "Open v10.0 — Bring Your Own Key, complete privacy overhaul
